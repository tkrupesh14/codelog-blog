...
$catShow = "SELECT * FROM  catagory WHERE id = $id";
...
if(isset($_POST['catBtn'])){
    ...
    $catUpe =  "UPDATE `catagory` SET `name` = '$catNameUp' WHERE `catagory`.`id` = '$id';";
...
<form action="" method="post" id="cat_name">
  ...
  <input type="submit" value="Edit Category" class="btn sb-btn-2" name="catBtn">
</form>
