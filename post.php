...
<div class="carousel-item <?= $ni ?>">
      <img src="./admin/Post Images/<?=$image ['image'] ?>" class="d-block w-100" alt="...">
    </div>
<?php
                    }
                  ?>
...
<a href="post.php?id=<?= $rpost ['id']?>" style="text-decoration: none; color:#000;">
    <div class="row g-0">
      ...
      <div class="col-md-5" style="background-image: url('./admin/Post Images/<?= getPostThumb($conn, $post ['id'])?>');background-size: cover">
